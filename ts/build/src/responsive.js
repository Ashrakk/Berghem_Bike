export class ResponsiveManager {
    constructor() {
        var _a, _b, _c;
        this.allColumnsElementsOriginalClasses = [];
        /*MENU STUFF*/
        ...
        //fix page
        window.addEventListener('resize', (evt) => { this.handleResponsiveness(evt); });
        this.handleResponsiveness();
        this.mobileMode(true);
        (_a = this.menuOpener) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => { this.handleMenuButton(); });
        (_b = this.pageLoader) === null || _b === void 0 ? void 0 : _b.classList.add('hidden');
        (_c = this.pageContainer) === null || _c === void 0 ? void 0 : _c.classList.remove('hidden');
    }
    mobileCheck() {
        let isMobile = false;
    ...
    mobileMode(status) {
        ...
        if (status === true && status !== this.mobileStatus) {
            (_a = this.allColumnsElements) === null || _a === void 0 ? void 0 : _a.forEach((elem) => {
                this.allColumnsElementsOriginalClasses[index] = elem.classList;
                elem.classList.remove('div_internal_column', 'column_width_1e6', 'column_width_1e5', 'column_width_1e4', 'column_width_1e3');
                elem.classList.add('paddingBottom20');
                index++;
            });
            (_b = this.allRowElements) === null || _b === void 0 ? void 0 : _b.forEach((elem) => {
                elem.classList.add('flexColumn');
            });
            this.mobileStatus = status;
            return;
        }
        else if (status === false && status !== this.mobileStatus) {
            (_c = this.allColumnsElements) === null || _c === void 0 ? void 0 : _c.forEach((elem) => {
                elem.classList.remove('paddingBottom20');
                this.allColumnsElementsOriginalClasses[index].forEach((currentValue, currentIndex, listObj) => {
                    elem.classList.add(currentValue);
                });
                index++;
            });
            (_d = this.allRowElements) === null || _d === void 0 ? void 0 : _d.forEach((elem) => {
                elem.classList.remove('flexColumn');
            });
            this.mobileStatus = status;
            return;
        }
    }
    handleResponsiveness(event) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
        let width = window.innerWidth;
        if (((width < 800 || this.mobileResponsive === true) && this.mobileStatus === false)) {
            this.mobileMode(true);
        }
        else if ((width > 800 && this.mobileStatus === true)) {
            this.mobileMode(false);
        }
        if ((width < 800 || this.mobileResponsive === true) && this.menuStatus === false) {
        ...
        if ((width < 800 || this.mobileResponsive === true) && this.menuStatus === true) {
        ...
        else if (width > 800 && this.mobileResponsive === false && this.menuStatus === false) {
        ...
        else if (width > 800 && this.mobileResponsive === false && this.menuStatus === true) {
